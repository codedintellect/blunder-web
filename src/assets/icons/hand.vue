<!-- Attr: https://healthicons.org/icon/filled/people/refused -->
<!--           Found through https://iconduck.com/            -->
...
<!--
  This icon is not sourced from Bootstrap Icons. This means the LICENSE
  specified in this folder does not apply to this item specifically.

  This icon comes from Health Icons, who have generously put it into the
  public domain.
  ...
  To the extent possible under law, Health Icons has waived all copyright and
  related or neighboring rights to icons available at Health Icons.
-->
